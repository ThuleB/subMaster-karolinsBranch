...
//	ColorBox greenBox = new ColorBox(new Color(0,0,225, 100)); 
	...
	public DialogFilter (JFrame frame, Color box1, Color box2){
	...
	public void showFrames(){
		...
		DialogFilter filterLeft = new DialogFilter(frameLeft, new Color(225, 0 , 0, 150),new Color(0,225,0, 150));
		...
		DialogFilter filterRight = new DialogFilter(frameRight, new Color(225, 225 , 0, 150), new Color(0, 0 , 225, 150));
